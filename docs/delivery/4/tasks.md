...
| 4-7 | [Balance Recovery — EEPROM Reset, Dither, Gain Logging](./4-7.md) | InProgress | Force source defaults via SETTINGS_MAGIC bump, replace piecewise stiction comp with zero-mean 40 Hz dither, and add per-second effective-gains line to the serial stream. |
